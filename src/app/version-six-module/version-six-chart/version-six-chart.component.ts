...
@Component({
  selector: 'app-version-six-chart',
  templateUrl: './version-six-chart.component.html',
  styleUrls: ['./version-six-chart.component.scss']
})
export class VersionSixChartComponent implements OnInit {
  ...
  private createChartSeries = (): Array<{type: string, data: Array<any>}> => {
    return  this.seriesService.getnSeries(4, 60).map(s => ( {
